...
public class CreateContactWithSupportDateTest {
	...
	public static void main(String[] args) throws Throwable {
		...
		if (SDate.contains(startDate)) {
			System.out.println(startDate + " StateDate =====>PASS");
		} else {
			System.out.println(startDate + " StateDate =====>FAIL");
		}

		String EDate = cip.endDateInfovalidations();
		if (EDate.contains(endDate)) {
			System.out.println(endDate + " EndDate =====>PASS");
		} else {
			System.out.println(endDate + " EndDate =====>FAIL");
		}
